...
const Groups = () => {
	const [groups] = useState([
		...
		},
		{
			...
			description:
				"Technojam Web specialty Group is Dedicated to development of Websites",
		},
		{
			id: 4,
			title: "Android",
			description:
				"Technojam Android specialty Group is Dedicated to development of Apps",
		},
		{
			id: 5,
			title: "CyberSecurity",
			description:
				"Technojam CyberSecurity specialty Group is Dedicated to Ethical hacking",
		},
		{
			id: 6,
			title: "Competitive Coding",
			description:
				"Technojam Competitive Coding specialty Group is Dedicated to Data Structures",
		},
	]);
