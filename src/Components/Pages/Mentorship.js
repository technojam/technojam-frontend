...
var sectionStyle = {
  ...
  height: "auto",
  backgroundImage:
    "url(https://tj-static.s3.ap-south-1.amazonaws.com/etc/pro.jpg)",
    ...
    this.state = {
      project: [
        ...
        },
        {
          ...
          info:
            "Technojam-Backend is build on Node and express Js. It uses MongoDB as its database.",
        ...
        <div id="1">
          <div style={sectionStyle}>
            ...
            >
              ...
              >
                Technojam Mentorship initiative is a global program focused on
                introducing students to open source software development. Since
                its inception this program aims on giving the very best
                experince of GSOC to enthusiast.
              </Typography>
