            ...
            <section>
                ...
                <div id="1">
                    <div style={sectionStyle}>
                        <div style={{ paddingTop: "330px", right: "", marginLeft: "auto", marginRight: "auto", maxWidth: "550px", paddingLeft: "20px" }}>
                            <Typography variant="h3" style={{ fontFamily: "Roboto", letterSpacing: "2px" }}>
                                2019 Projects
                             </Typography><br></br><br></br>

                            <Typography variant="body2" style={{ fontFamily: "Roboto", letterSpacing: "1px", fontSize: "21px", lineHeight: "35px", wordSpacing: "5px" }}>
                                Technojam Mentorship initiative is a global program focused on introducing students to open source software development. Since its inception
                                this program aims on giving the very best experince of GSOC to enthusiast.
                              </Typography>
                                     ...
                                     <ExpansionPanel style={{
                                                    ...
                                                    <ExpansionPanelSummary>
                                                        <Grid item md={6} xl={6} alignContent="flex-end" justify="flex-end">
                                                            <Typography variant="h5" component="p" style={{ fontFamily: "Roboto", letterSpacing: "2px", textAlign: "end",fontSize:"32px"}} >
                                                                {project.title}
                                                            </Typography>
                                                        </Grid>
                                                        <Grid item md={6} xl={6}>
                                                            <Typography style={{ fontFamily: "Roboto", letterSpacing: "0.9px", paddingLeft: "25px", paddingTop: "4px", wordSpacing: "3px" }}>
                                                                {project.info}
                                                            </Typography>
                                                        </Grid>
                                                    </ExpansionPanelSummary>
                                                    ...
                                                    <ExpansionPanelDetails>
                                                        <Grid item md={6} xl={6}>
                                                            <Typography variant="h6" style={{ fontFamily: "Roboto", letterSpacing: "2px", textAlign: "end" }} >
                                                                Skills
                                                        </Typography>
                                                        </Grid>
                                                        <Grid item md={6} xl={6}>
