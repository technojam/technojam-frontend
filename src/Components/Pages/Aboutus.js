                ...
                <div >
                    <Grid container
                        ...
                        <Grid item lg={6} md={6} sm={12} alignItems="center">
                            <Card style={{
                                backgroundColor: " #e03030", opacity: "0.9", minHeight: "530px",
                                ...
                                <CardContent >
                                    ...
                                    face any hurdles in the way of learning new tactics to deal with ever changing or dynamic technology.</p>
                                        <p>Also we hope, it is our soul duty to work on those projects which will make our institute technically
                                        advanced and prepare our country well enough to compete with other established high tech countries & also
                                    the emerging countries which are technically very sound.</p><p> We are technically far behind in compare to those
                                    technically advanced countries.</p><p> There can be an abrupt change only if we toil hard with a never say die spirit
                                        having 100% dedication and devotion to our work, motivating and inspiring the young and creative minds in the
                        ...
                        <Grid item lg={6} md={6} sm={12}>
                            <Card style={{
                                backgroundColor: "#33a351", opacity: "0.9", boxShadow: " 0 30px 35px 0 rgba(0, 0, 0, 0.2), 0 20px 30px 0 rgba(0, 0, 0, 0.19)",
                                ...
                                <CardContent >
                                    ...
                                    institute as a leader in innovation and creativity.</p>
                                        <p>2. To enhance the technical innovativeness of our institute students by organizing the workshops and
                                          competitions on various technical level in order to attract the interest of the student s towards technical
                                     aspects of their education.</p>
                                        <p>3. Provide a platform where the students can put their innovative efforts and clear their doubts to transform
                                     them into reality.</p>
